...
<nav class="navbar navbar-light bg-light navbar-expand-lg sticky-top navbar_bottom">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <?php
                    echo "<a class='nav-link' href='index.php?op=products'>Products</a>";
                ?>
            </li>
...
<!-- Modal for SignIn, SignUp, Forgot Password -->
<div class="modal fade" id="user-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <?php
            include("components/modals/sign_in.php");// modal for login
            include("components/modals/sign_up.php"); // modal for new user
            include("components/modals/forgot_pass.html"); // modal for forget pass
        ?>
    </div>
</div>
