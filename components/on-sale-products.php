<div class="container">
    <h1>Akcije</h1>
    <!--Carousel Wrapper-->
    <div id="on-sale-products" class="carousel slide carousel-multi-item" data-ride="carousel">

        <!--Controls-->
        <div class="controls-top">
            <a class="btn-floating" href="#on-sale-products" data-slide="prev"><i class="fa fa-chevron-left"></i></a>
            <a class="btn-floating" href="#on-sale-products" data-slide="next"><i class="fa fa-chevron-right"></i></a>
        </div>
        <!--/.Controls-->
        ...
        WHERE p.ProductPromotionalPrice != ''";
